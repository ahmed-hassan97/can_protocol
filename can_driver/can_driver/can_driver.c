...
/**
 * @brief  CAN1_RX PA11 and CAN1_TX PA12
 */
...
void CAN1_Init(void){
	...
	/* Configure GPIO with AF9, CAN1 connected to APB1 with 45MHz clock
	  ...
	  /* Configure CAN1 */
	    ...
	    while((CAN_MSR_INAK != (CAN_MSR_INAK & CAN1->MSR))){
...
void gpio_init(){
	...
	gpiod.GPIO_Pin = GPIO_Pin_12 | GPIO_Pin_13 | GPIO_Pin_14 | GPIO_Pin_15;

	gpiod.GPIO_Speed = GPIO_Speed_25MHz;
